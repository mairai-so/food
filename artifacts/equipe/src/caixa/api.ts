...
function headers(json = true): Record<string, string> {
  ...
  // Multi-loja (15/08/2026, corrigido): esta é uma cópia do api.ts do Caixa
  // standalone (embutida na visão CaixaView do App Equipe) — não tinha o
  // header x-loja-id, então a visão de Caixa dentro do Equipe nunca respeitava
  // qual loja estava ativa, diferente do app Caixa de verdade.
